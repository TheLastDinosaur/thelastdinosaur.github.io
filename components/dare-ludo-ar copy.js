...
var pawnsforRobo = [];
var gameTimer;
var timeLimit = 30; //Setup time limit in seconds
...
var whoAmI;
var whoIsPlaying;
var allPlayers = ["Your Turn", "Green's Turn", "Yellow's Turn", "Blue's Turn" ];
...
const RollDice = function(){
 ...
 //Decide whether to spawn or move based on the Dice value
...
//ENABLE PLAYER FOR SPAWNING
 const EnableSpawning = function(whomToMove){
    ...
    whoisMoving.setAttribute('animation',{"property": "scale", "to": "1 1 1", "dur": "1000", "dir": "alternate",  "loop": "true"});
...
// Remove the trigger to move or spawn from all the pawns
const RemoveTrigger = function (){
    ...
    for(i =0; i < allPlayers.length; i++){
        ...
        allPlayers[i].setAttribute("scale", "0.5 0.5 0.5");
    }
}
